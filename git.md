...
![](assets/images/git/file-20250329161938.png)
## 1.3代码托管中心
...
![](assets/images/git/file-20250329162012.png)

## 2.2文件删除

>在本地删除文件后需要重新提交删除信息，add后再commit，不然删除的只是工作区的文件

![](assets/images/git/file-20250329161811.png)
![](assets/images/git/file-20250329161902.png)
...
![](assets/images/git/file-20250329162041.png)
![](assets/images/git/file-20250329162048.png)
![](assets/images/git/file-20250329162057.png)

>通过`git stash pop`弹出暂存文件，继续修改

![](assets/images/git/file-20250329162106.png)
...
![](assets/images/git/file-20250329162123.png)
## 3.2常用分支命令
```bash
#创建分支
git branch 分支名
...
![](assets/images/git/file-20250329162136.png)

![](assets/images/git/file-20250329175454.png)
...
![](assets/images/git/file-20250329175730.png)
## 3.4pull指令
...
![](assets/images/git/file-20250329162213.png)
...
![](assets/images/git/file-20250329162221.png)
...
![](assets/images/git/file-20250329162234.png)

![](assets/images/git/file-20250329162243.png)

>去掉文件中的多余信息，只留下要的内容，并再次添加提交该文件，commit时不要带上文件名

![](assets/images/git/file-20250329162314.png)

![](assets/images/git/file-20250329162258.png)
# 4.git团队协作机制
## 4.1团队内协作
...
![](assets/images/git/file-20250329162323.png)
![](assets/images/git/file-20250329162332.png)
![](assets/images/git/file-20250329162342.png)
## 5.4克隆远程库到本地库
...
![](assets/images/git/file-20250329162355.png)
...
![](assets/images/git/file-20250329173951.png)
